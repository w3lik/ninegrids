...
ui:onSetup(function(this)
    ...
    stage.shiftBtn = FrameButton(kit .. "->shiftBtn", stage.main)
        ...
        :texture(AUIKit("ninegrids_essence", "btn\\e_green", "tga"))
        ...
        function(evtData)
            ...
            if (stage.detailType == "data") then
                ...
                evtData.triggerFrame:texture(AUIKit("ninegrids_essence", "btn\\e_red", "tga"))
            else
                stage.detailType = "data"
                evtData.triggerFrame:text("查看说明")
                evtData.triggerFrame:texture(AUIKit("ninegrids_essence", "btn\\e_green", "tga"))
            end
            this:updated()
        end)
    ...
    stage.detailBtn = FrameButton(kit .. "->detailBtn", ctlStage.bg)
        ...
        :prop("texture", AUIKit("ninegrids_essence", "btn/i_what", "tga"))
        :alpha(160)
        :size(0.02, 0.02)
...
function ui:display()
    ...
    if (showing) then
        ...
        stage.shiftBtn:texture(AUIKit("ninegrids_essence", "btn\\e_green", "tga"))
        return
    end
    audio(Vcm("war3_MouseClick1"))
