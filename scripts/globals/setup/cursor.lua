Game():onEvent(EVENT.Game.Start, "myCursor", function()
    ...
    local csTexture = {
        pointer = {
            ...
            height = 0.016 * 68 / 46,
            normal = "cursor\\arrow\\normal.tga",
            ally = "cursor\\arrow\\focus.tga",
            enemy = "cursor\\arrow\\attack.tga",
        },
        drag = {
            alpha = 255,
            width = 0.04,
        ...
        aim = {
            ...
            width = 0.04,
            height = 0.04,
            normal = "cursor\\aim\\white.tga",
            ally = "cursor\\aim\\green.tga",
    ...
    -- 自定义默认指针逻辑
    cursor.setStatus(cursor._default, true)
    cursor.setDefault({
        start = function()
            _int1 = 0
            _bool1 = false
