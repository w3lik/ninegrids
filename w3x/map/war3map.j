...
function main takes nothing returns nothing
    call SetCameraBounds(- 6912.0 + GetCameraMargin(CAMERA_MARGIN_LEFT), - 6400.0 + GetCameraMargin(CAMERA_MARGIN_BOTTOM), 6400.0 - GetCameraMargin(CAMERA_MARGIN_RIGHT), 6400.0 - GetCameraMargin(CAMERA_MARGIN_TOP), - 6912.0 + GetCameraMargin(CAMERA_MARGIN_LEFT), 6400.0 - GetCameraMargin(CAMERA_MARGIN_TOP), 6400.0 - GetCameraMargin(CAMERA_MARGIN_RIGHT), - 6400.0 + GetCameraMargin(CAMERA_MARGIN_BOTTOM))
